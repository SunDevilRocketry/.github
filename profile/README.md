...
### Firmware
The firmware division is responsible for all of the code that runs on SDR's custom hardware. Their most known project is the [firmware for the Flight Computer](https://github.com/SunDevilRocketry/Flight-Computer-Firmware), but they also have a [ground station](https://github.com/SunDevilRocketry/Ground-Station-Firmware) for wireless telemetry, maintain a [command line interface](https://github.com/SunDevilRocketry/sdec) for SDR boards, and assist with [liquids](https://github.com/SunDevilRocketry/Engine-Controller-Firmware) when needed.
### Software
The software division is responsible for SDR's newest projects. They are currently working on developing an [application to interface with the flight computer](https://github.com/SunDevilRocketry/Flight-Software-GUI), [drivers for industry grade DAQ hardware like the Labjack T7](https://github.com/SunDevilRocketry/Linux-DAQ-Driver), and a rework of [SDEC](https://github.com/SunDevilRocketry/SDECv2) using proper object oriented design principles.
